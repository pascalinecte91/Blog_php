      ...
      <body>
                          ...
                          <div class="page-heading">
                              ...
                              <h3> Pascale CHRISTOPHE <h3>
                                      ...
                                      <span class=<h3>Un projet ? Faisons le ENSEMBLE</h3</span>
                                          <a href="/cvProjet5.pdf" style="color:rgba(143, 14, 248, 0.918)"><br>Mon CV</a>
          ...
          <footer class="bg-dark text-white py-4  mt-auto">
              <div class="d-flex justify-content-around">
                  <a href="https://fr.facebook.com" style="color: #02b5fc"><i class="fa fa-facebook fa-2x"></i>
                      Facebook</a>
                  <a href="https://twitter.com/explore" style="color: red"><i class="fa fa-twitter fa-2x"></i> Twitter
                  </a>
                  ...
                  <a href="https://fr.linkedin.com/" style="color: #f7f10a"><i class="fa fa-linkedin fa-2x"></i>
                      Linkedin</a>
